...
def start_simulation_thread():
    ...
    sim_thread = threading.Thread(target=execute_llm, daemon=True)
...
# Change this line:
btn_start = ttk.Button(button_frame, text="Start Simulation", command=lambda: start_simulation_thread)
